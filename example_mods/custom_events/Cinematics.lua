...
function onUpdate()
	...
	doTweenAlpha('AlphaTween0', 'healthBarBG', 0, 0.25)
	doTweenAlpha('AlphaTween1', 'healthBar', 0, 0.25)
	doTweenAlpha('AlphaTween2', 'healthBarOverlay', 0, 0.25)
	...
	doTweenAlpha('AlphaTween0', 'healthBarOverlay', 1, 0.25)
